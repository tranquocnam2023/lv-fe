    ...
    content: (
      <div className="space-y-6">
        <div className="bg-gray-50 p-6 rounded-md border border-gray-200 text-sm text-gray-700 leading-relaxed">
          <p>PhoneShop.com xin lỗi vì sự cố khiến điện thoại của quý khách bị hỏng và phải đi bảo hành. PhoneShop có 2 hỗ trợ dành riêng cho khách hàng mua điện thoại tại PhoneShop trong thời gian đi bảo hành như sau:</p>
          <ul className="list-disc pl-5 mt-3 space-y-2">
            <li>PhoneShop cung cấp cho khách hàng một điện thoại đã qua sử dụng để khách hàng sử dụng tạm thời trong thời gian bảo hành. Chi tiết máy cung cấp quý khách có thể hỏi nhân viên siêu thị hoặc xem trên giấy tiếp nhận bảo hành/sửa chữa dịch vụ.</li>
