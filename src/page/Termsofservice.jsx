    ...
    return (
        <div className="container-box py-10 text-sm" style={{ color: THEME.textDark }}>
            ...
            <div className="bg-white rounded-lg border border-admin-border/60 p-5 shadow-sm">
                ...
                <h2 className="text-xl font-bold mb-3 text-admin-text-main">5. Đồng ý vá chấp thuận các điều khoản</h2>
                <p className="mb-3">Việc bạn tiếp tục sử dụng và mua hàng ở trang web là đồng ý với các điều khoản ở đây và trong mục chính sách bảo hành và chính sách đổi trả</p>
            </div>
        </div>
    );
}