        ...
        <div className="container-box py-10 text-sm" style={{ color: THEME.textDark }}>
            ...
            <div className="bg-white rounded-lg border border-admin-border/60 p-5 shadow-sm">
                <p className="mb-4 text-gray-600">
                    <strong>Ngày có hiệu lực:</strong> 2026-08-12
                </p>
                
                <section className="mb-6">
                    <h2 className="text-xl font-bold mb-3 text-admin-text-main">1. Chấp nhận Điều khoản</h2>
                    <p className="mb-3">Bằng cách sử dụng trang web <strong>mwg-phone-shop.netlify.app</strong>, bạn đồng ý với các điều khoản và điều kiện này. Nếu bạn không đồng ý với bất kỳ phần nào của các điều khoản này, vui lòng không sử dụng trang web.</p>
                </section>

                <section className="mb-6">
                    <h2 className="text-xl font-bold mb-3 text-admin-text-main">2. Quyền sở hữu trí tuệ</h2>
                    <p className="mb-3">Trang web và nội dung của nó, bao gồm nhưng không giới hạn văn bản, đồ họa, hình ảnh, logo và phần mềm, là tài sản của <strong>mwg-phone-shop.netlify.app</strong> hoặc các nhà cấp phép của nó và được bảo vệ bởi luật bản quyền và các luật sở hữu trí tuệ khác.</p>
                </section>

                <section className="mb-6">
                    <h2 className="text-xl font-bold mb-3 text-admin-text-main">3. Giới hạn trách nhiệm</h2>
                    <p className="mb-3"><strong>mwg-phone-shop.netlify.app</strong> sẽ không chịu trách nhiệm pháp lý đối với bất kỳ thiệt hại gián tiếp, ngẫu nhiên, đặc biệt hoặc do hậu quả nào phát sinh từ việc sử dụng hoặc không có khả năng sử dụng trang web.</p>
                </section>
