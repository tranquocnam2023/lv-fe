    ...
    <>
      ...
      >
        <button 
          ...
          className="flex-shrink-0 flex items-center gap-1.5 px-3 sm:px-4 py-2 border rounded text-sm transition-colors font-medium border-gray-300 text-gray-700 bg-white hover:border-primary hover:text-primary cursor-pointer"
        >
        ...
        <div className="flex-1 flex items-center gap-2 overflow-x-auto no-scrollbar py-0.5 whitespace-nowrap">
          ...
          {selectedBrand && (
            <button 
              ...
              className="flex-shrink-0 flex items-center gap-1 px-3 py-1.5 text-[13px] text-red-500 hover:text-red-700 transition-colors font-medium border border-red-100 rounded bg-red-50/30 cursor-pointer"
            >
          ...
          {onClearAll && (
            <button 
              onClick={onClearAll}
              className="flex-shrink-0 flex items-center gap-1 px-3 py-1.5 text-[13px] text-gray-500 hover:text-red-600 transition-colors font-medium border border-gray-200 rounded hover:border-red-200 hover:bg-red-50 cursor-pointer"
            >
