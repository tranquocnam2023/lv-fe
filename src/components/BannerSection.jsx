...
const BannerSection = ({ showSideBanners = true, showTopBanner = true, showSlider = true }) => {
  ...
  return (
    <>
      ...
      {/* PHẦN 2: QUẢNG CÁO TĨNH TRÊN CÙNG (TOP BANNER) */}
      {showTopBanner && (
      ...
      {/* PHẦN 3: ĐOÀN TÀU SLIDER CHẠY 2 HÌNH SONG SONG */}   
      {showSlider && (
